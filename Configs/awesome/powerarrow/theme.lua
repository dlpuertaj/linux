...
local cpu_widget = require("themes.powerarrow.cpu-widget"){
    width = 70,
    step_width = 2,
    step_spacing = 0,
    color = '#434c5e',
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#CB755B"),
            arrow("#CB755B", "#8DAA9A"),
            wibox.container.background(wibox.container.margin(wibox.widget { nill, cpu_widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#8DAA9A"),
            arrow("#8DAA9A", "#C0C0A2"),
            wibox.container.background(wibox.container.margin(wibox.widget { theme.weather.icon, theme.weather, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), "#C0C0A2"),
            arrow("#C0C0A2", "#777E76"),
